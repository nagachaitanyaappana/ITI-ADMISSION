...
public class ItiTradeMstDto {
    ...
    public String getTradeFreeze() {
        return tradeFreeze;
    }

    public void setTradeFreeze(String tradeFreeze) {
    ...
    public Integer getMaxInternalMarks() {
        return maxInternalMarks;
    }

    public void setMaxInternalMarks(Integer maxInternalMarks) {
